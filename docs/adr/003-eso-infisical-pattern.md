...
- The ESO `PushSecret` resource is banned. The Infisical ESO provider does not support PushSecret, and the architectural pattern of pushing secrets from cluster operators back to the System of Record is fragile.
