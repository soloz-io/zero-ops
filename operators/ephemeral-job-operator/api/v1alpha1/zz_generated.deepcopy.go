...
func (in *EphemeralJobSpec) DeepCopyInto(out *EphemeralJobSpec) {
	*out = *in
	...
	if in.WorkspacePersistence != nil {
		in, out := &in.WorkspacePersistence, &out.WorkspacePersistence
		*out = new(WorkspacePersistenceSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkspacePersistenceSpec) DeepCopyInto(out *WorkspacePersistenceSpec) {
	*out = *in
	if in.KeepCheckpoints != nil {
		in, out := &in.KeepCheckpoints, &out.KeepCheckpoints
		*out = new(int32)
		**out = **in
	}
	if in.PinnedCheckpoints != nil {
		in, out := &in.PinnedCheckpoints, &out.PinnedCheckpoints
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkspacePersistenceSpec.
func (in *WorkspacePersistenceSpec) DeepCopy() *WorkspacePersistenceSpec {
	if in == nil {
		return nil
	}
	out := new(WorkspacePersistenceSpec)
