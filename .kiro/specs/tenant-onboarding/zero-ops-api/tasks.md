...
- [ ] 1.2 Add dependencies: Gin, pgxpool, sqlc, zap, Prometheus client, testify
- [ ] 1.3 Create project structure (cmd/, internal/, pkg/)
- [ ] 1.4 Create Makefile with targets: sqlc-generate, migrate-up, migrate-down, test
