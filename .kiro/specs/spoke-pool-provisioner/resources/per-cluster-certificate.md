...
The file `catalog/security/argocd-agent-cert.yaml` defines certificates in the **wrong namespace** (`argocd`) and uses a **template approach** that doesn't match the design.
