...
- [ ] 1.7.1 Create ADR for ClusterResourceSet addon template management
...
- [ ] 1.7.2 Create directory structure for cluster BIOS templates
...
- [ ] 1.7.3 Create Cilium CNI addon template
...
- [ ] 1.7.4 Create Hetzner CCM addon template
...
- [ ] 1.7.5 Create ArgoCD Agent addon templates
...
- [ ] 1.7.6 Refactor hub bootstrap CLI to use static templates
...
- [ ] 1.7.7 Create ArgoCD Application for cluster BIOS templates
...
- [ ] 1.7.8 Commit cluster BIOS templates to Git
