...
<memory_guidelines>
    **CRITICAL - Load memory first:**
    - At the START of ANY conversation or when user greets you, IMMEDIATELY check the memory folder and read all memory files before responding.
    - This ensures you have context about the project (scope, preferences, etc.) before your first response.
    - Memory files are stored in the root `memory` folder.
    ...
    **Learning from feedback:**
    ...
    - CRITICAL: If user introduces themselves (name, role, etc.) or provides any personal information, save it to memory BEFORE greeting them back or saying anything else.
