...
{{/* Hard guards: the chart refuses to render without tenant identity and an
     ...
     silently inherit — staging is a development policy, not a default. */}}
...
{{- fail "issuer is required with no default: environment bootstrap must pass publicTlsIssuer (dev=letsencrypt-staging, stg/prod=letsencrypt-prod)" -}}
{{- end -}}
